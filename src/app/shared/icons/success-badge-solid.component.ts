...
@Component({
  selector: 'app-success-badge-solid',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: `
    <svg
      class="success-badge-solid"
      [attr.width]="size()"
      [attr.height]="size()"
      viewBox="0 0 48 48"
      fill="none"
    ...
    >
      <circle cx="24" cy="24" r="24" fill="var(--nc-color-primary)" />
      <path
        [attr.d]="tickPath"
        stroke="white"
  ...
  `,
  styleUrl: './success-badge-solid.component.scss',
})
export class SuccessBadgeSolidComponent {
